...
namespace NativeCollections
{
    ...
    /// </summary>
    /// <remarks>https://xoshiro.di.unimi.it/xoshiro256plusplus.c</remarks>
    [StructLayout(LayoutKind.Sequential)]
    [UnsafeCollection(FromType.Community | FromType.C)]
    public unsafe struct UnsafeXoshiro256PlusPlus : IIsCreated, IInitializable, IRandom, IEquatable<UnsafeXoshiro256PlusPlus>
    {
        /// <summary>
        ...
        public UnsafeXoshiro256PlusPlus(ulong s0, ulong s1, ulong s2, ulong s3) => _state = new State(s0, s1, s2, s3);
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnsafeXoshiro256PlusPlus(ReadOnlySpan<byte> buffer) => _state = new State(buffer);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly bool Equals(UnsafeXoshiro256PlusPlus other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly override bool Equals(object? obj) => obj is UnsafeXoshiro256PlusPlus other && other.Equals(this);
        ...
        /// </summary>
        public readonly override string ToString() => "UnsafeXoshiro256PlusPlus";

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(UnsafeXoshiro256PlusPlus left, UnsafeXoshiro256PlusPlus right) => left.Equals(right);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnsafeXoshiro256PlusPlus Create()
        {
            Unsafe.SkipInit(out UnsafeXoshiro256PlusPlus random);
            random.Initialize();
            return random;
        }
        ...
        /// </summary>
        public static UnsafeXoshiro256PlusPlus Empty => default;

        /// <summary>
        ///     Provides a thread-safe instance that may be used concurrently from any thread.
        /// </summary>
        public static ThreadSafeRandom<UnsafeXoshiro256PlusPlus> Shared => new();
