...
namespace NativeCollections
{
    ...
    public unsafe struct UnsafeDeque<T> : IIsCreated, IDisposable, IEquatable<UnsafeDeque<T>>, IReadOnlyCollection<T> where T : unmanaged
    {
        /// <summary>
        ...
        /// </summary>
        public readonly bool Equals(UnsafeDeque<T> other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly override bool Equals(object? obj) => obj is UnsafeDeque<T> other && other.Equals(this);
        ...
        /// </summary>
        public readonly override string ToString() => SR.Format("UnsafeDeque<{0}>", SR.GetTypeName(typeof(T)));

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(UnsafeDeque<T> left, UnsafeDeque<T> right) => left.Equals(right);
        ...
        /// </summary>
        public static UnsafeDeque<T> Empty => default;
        ...
        public struct Enumerator : IIterator<T>
        {
            ...
            /// </summary>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            internal Enumerator(UnsafeDeque<T>* handle)
            {
                _handle = handle;
