...
namespace NativeCollections
{
    ...
    public unsafe struct UnsafeAtomicChar
    {
        /// <summary>
        ///     Value
        /// </summary>
        ...
        public UnsafeAtomicChar(char value) => _value = new UnsafeAtomicU16(value);
        ...
        public ref char AsRef() => ref Unsafe.As<UnsafeAtomicU16, char>(ref _value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Nand(char value) => (char)_value.Nand(value);
        ...
        /// <returns>The original value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char And(char value) => (char)_value.And(value);
        ...
        /// <returns>The original value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Or(char value) => (char)_value.Or(value);
        ...
        /// <returns>The original value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Xor(char value) => (char)_value.Xor(value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Add(char value) => (char)_value.Add(value);
        ...
        /// <returns>The new value stored.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Sub(char value) => (char)_value.Sub(value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char Load(Ordering order) => (char)_value.Load(order);
        ...
        /// <exception cref="NotSupportedException">Ordering is not supported.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Store(char value, Ordering order) => _value.Store(value, order);
        ...
        /// <returns>The original value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public char CompareExchange(char value, char comparand) => (char)_value.CompareExchange(value, comparand);
        ...
        /// </summary>
        public readonly override string ToString() => "UnsafeAtomicChar";

        /// <summary>
        ///     Empty
        /// </summary>
        public static UnsafeAtomicChar Empty => default;
    }
}