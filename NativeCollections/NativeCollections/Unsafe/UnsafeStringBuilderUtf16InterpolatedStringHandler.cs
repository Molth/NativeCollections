...
namespace NativeCollections
{
    ...
    public readonly unsafe ref struct UnsafeStringBuilderUtf16InterpolatedStringHandler
...
#endif
    {
        ...
        private readonly struct UnsafeStringBuilderHandle : IIsCreated
        {
            ...
            ///     Handle
            /// </summary>
            private readonly UnsafeStringBuilder<char>* _handle;
        ...
        /// </remarks>
        public UnsafeStringBuilderUtf16InterpolatedStringHandler(int literalLength, int formattedCount, in UnsafeStringBuilder<char> stringBuilder)
        {
        ...
        ///     be for members intended to be used directly.
        /// </remarks>
        public UnsafeStringBuilderUtf16InterpolatedStringHandler(int literalLength, int formattedCount, in UnsafeStringBuilder<char> stringBuilder, IFormatProvider? provider)
        {
            _stringBuilder = new UnsafeStringBuilderHandle(stringBuilder);
            _provider = provider;
        ...
        public override string ToString() => "UnsafeStringBuilderUtf16InterpolatedStringHandler";
