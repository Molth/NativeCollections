...
namespace NativeCollections
{
    ...
    /// </summary>
    /// <remarks>https://xoshiro.di.unimi.it/xoshiro256starstar.c</remarks>
    [StructLayout(LayoutKind.Sequential)]
    [UnsafeCollection(FromType.Standard)]
    public unsafe struct UnsafeXoshiro256 : IIsCreated, IInitializable, IRandom, IEquatable<UnsafeXoshiro256>
    {
        /// <summary>
        ///     State
        /// </summary>
        ...
        public UnsafeXoshiro256(ulong s0, ulong s1, ulong s2, ulong s3) => _state = new State(s0, s1, s2, s3);

        /// <summary>
        ///     Structure
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnsafeXoshiro256(ReadOnlySpan<byte> buffer) => _state = new State(buffer);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly bool Equals(UnsafeXoshiro256 other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly override bool Equals(object? obj) => obj is UnsafeXoshiro256 other && other.Equals(this);
        ...
        /// </summary>
        public readonly override string ToString() => "UnsafeXoshiro256";

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(UnsafeXoshiro256 left, UnsafeXoshiro256 right) => left.Equals(right);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnsafeXoshiro256 Create()
        {
            Unsafe.SkipInit(out UnsafeXoshiro256 random);
            random.Initialize();
            return random;
        }
        ...
        ///     Empty
        /// </summary>
        public static UnsafeXoshiro256 Empty => default;

        /// <summary>
        ///     Provides a thread-safe instance that may be used concurrently from any thread.
        /// </summary>
        public static ThreadSafeRandom<UnsafeXoshiro256> Shared => new();
