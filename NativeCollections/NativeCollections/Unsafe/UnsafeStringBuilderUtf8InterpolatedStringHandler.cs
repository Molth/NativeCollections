...
namespace NativeCollections
{
    ...
    ///     <see cref="UnsafeStringBuilder{T}" /> instances.
    /// </summary>
    ...
    public readonly unsafe ref struct UnsafeStringBuilderUtf8InterpolatedStringHandler
...
#endif
    {
        ...
        private readonly struct UnsafeStringBuilderHandle : IIsCreated
        {
            ...
            public UnsafeStringBuilderHandle(in UnsafeStringBuilder<byte> builder) => _handle = UnsafeHelpers.AsPointer(ref builder.AsRef());
            ...
            /// </summary>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ref UnsafeStringBuilder<byte> AsRef() => ref Unsafe.AsRef<UnsafeStringBuilder<byte>>(_handle);
        }

        /// <summary>
        ///     The associated UnsafeStringBuilder to which to append.
        /// </summary>
        private readonly UnsafeStringBuilderHandle _stringBuilder;
        ...
        /// <param name="stringBuilder">The associated UnsafeStringBuilder to which to append.</param>
        /// <remarks>
        ...
        /// </remarks>
        public UnsafeStringBuilderUtf8InterpolatedStringHandler(int literalLength, int formattedCount, in UnsafeStringBuilder<byte> stringBuilder)
        {
            _stringBuilder = new UnsafeStringBuilderHandle(stringBuilder);
            _provider = null;
        ...
        ///     be for members intended to be used directly.
        /// </remarks>
        public UnsafeStringBuilderUtf8InterpolatedStringHandler(int literalLength, int formattedCount, in UnsafeStringBuilder<byte> stringBuilder, IFormatProvider? provider)
        {
            _stringBuilder = new UnsafeStringBuilderHandle(stringBuilder);
            _provider = provider;
        ...
        /// <summary>
        ///     Formats into temporary space and then appends the result into the UnsafeStringBuilder.
        /// </summary>
        private void AppendFormattedWithTempSpace<T>(T value, int alignment, string? format)
        {
            using var handler = new UnsafeStringBuilder<char>(stackalloc char[512], 0);
