...
namespace NativeCollections
{
    ...
    public readonly unsafe struct NativeConcurrentDictionary<TKey, TValue> : IDisposable, IEquatable<NativeConcurrentDictionary<TKey, TValue>> where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged
    {
        /// <summary>
        ///     Handle
        /// </summary>
    ...
    internal static class NativeConcurrentDictionaryTypeProps<T>
    {
        /// <summary>
        ///     Is write atomic
        /// </summary>
