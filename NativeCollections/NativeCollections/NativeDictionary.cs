...
namespace NativeCollections
{
    ...
    public readonly unsafe struct NativeDictionary<TKey, TValue> : IDisposable, IEquatable<NativeDictionary<TKey, TValue>> where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged
    {
        ...
        {
            var handle = _handle;
            return ref nint.Size == 8 ? ref handle->Buckets[HashHelpers.FastMod(hashCode, (uint)handle->BucketsLength, handle->FastModMultiplier)] : ref handle->Buckets[hashCode % handle->BucketsLength];
        }
