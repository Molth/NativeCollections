...
namespace NativeCollections
{
    ...
    public unsafe struct StackallocOrderedDictionary<TKey, TValue> : IIsCreated, IEquatable<StackallocOrderedDictionary<TKey, TValue>>, IReadOnlyCollection<KeyValuePair<TKey, TValue>> where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged
    {
        ...
        /// <returns>
        ///     <see cref="InsertResult.Success" /> if the key/value pair was added to this successfully;
        ...
        /// <returns>
        ///     <see cref="InsertResult.Success" /> if the key/value pair was added to this successfully;
        ///     or if an existing element was overwritten <see cref="InsertResult.Overwritten" />
        ///     otherwise, <see langword="false" />.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public InsertResult TryAddOrUpdate(in TKey key, in TValue value) => TryInsertOverwriteExisting(-1, key, value);
        ...
        ///     <typeparamref name="TValue" /> when the search yielded no match.
        /// </param>
        ...
        public bool TryGetValueRefOrAddDefault(in TKey key, out NativePtr<TValue> value)
        {
            ...
            if (index1 >= 0)
            {
                value = new NativePtr<TValue>(UnsafeHelpers.AsPointer(ref Unsafe.Add(ref Unsafe.AsRef<Entry>(_entries), (nint)index1).Value));
                return true;
            }
