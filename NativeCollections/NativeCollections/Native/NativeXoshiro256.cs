...
namespace NativeCollections
{
    ...
    public unsafe struct NativeXoshiro256 : IEquatable<NativeXoshiro256>
    {
        ...
        {
            ThrowHelpers.ThrowIfLessThan(buffer.Length, Unsafe.SizeOf<NativeXoshiro256>(), ExceptionArgument.buffer);
        ...
        public readonly bool Equals(NativeXoshiro256 other)
        {
            ...
            return SpanHelpers.Equals(ref local1, ref local2, (nuint)Unsafe.SizeOf<NativeXoshiro256>());
        }
        ...
        {
            var data = MemoryMarshal.CreateSpan(ref Unsafe.As<ulong, byte>(ref _s0), Unsafe.SizeOf<NativeXoshiro256>());
            do
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NativeXoshiro256 Create()
        {
            Unsafe.SkipInit(out NativeXoshiro256 random);
            random.Initialize();
            return random;
        }
