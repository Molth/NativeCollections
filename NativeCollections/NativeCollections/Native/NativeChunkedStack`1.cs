...
namespace NativeCollections
{
    ...
    public readonly unsafe struct NativeChunkedStack<T> : IIsCreated, IDisposable, IEquatable<NativeChunkedStack<T>>, IReadOnlyCollection<T> where T : unmanaged
    {
        /// <summary>
        ///     Handle
        /// </summary>
        ...
        /// </summary>
        public bool Equals(NativeChunkedStack<T> other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public override bool Equals(object? obj) => obj is NativeChunkedStack<T> other && other.Equals(this);
        ...
        /// </summary>
        public override string ToString() => SR.Format("NativeChunkedStack<{0}>", SR.GetTypeName(typeof(T)));

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(NativeChunkedStack<T> left, NativeChunkedStack<T> right) => left.Equals(right);
        ...
        ///     Empty
        /// </summary>
        public static NativeChunkedStack<T> Empty => default;

        /// <summary>
        ///     Returns an enumerator that iterates through the collection.
        /// </summary>
        public UnsafeChunkedStack<T>.Enumerator GetEnumerator() => new(_handle);
