...
namespace NativeCollections
{
    ...
    public readonly unsafe struct NativeDeque<T> : IDisposable, IEquatable<NativeDeque<T>>, IReadOnlyCollection<T> where T : unmanaged
    {
        /// <summary>
        ///     Handle
        /// </summary>
        ...
        public NativeDeque(int capacity)
        {
            ...
            var handle = NativeMemoryAllocator.AlignedAlloc<UnsafeDeque<T>>(1);
            Unsafe.AsRef<UnsafeDeque<T>>(handle) = value;
            _handle = handle;
        }
