...
namespace NativeCollections
{
    ...
    public readonly unsafe struct NativeFixedSizeMemoryPool<T> : IDisposable, IEquatable<NativeFixedSizeMemoryPool<T>> where T : unmanaged
    {
        /// <summary>
        ///     Handle
        /// </summary>
        ...
        public bool Equals(NativeFixedSizeMemoryPool<T> other) => other == this;
        ...
        /// <returns>Equals</returns>
        public override bool Equals(object? obj) => obj is NativeFixedSizeMemoryPool<T> nativeFixedSizeMemoryPool && nativeFixedSizeMemoryPool == this;
        ...
        public override string ToString() => $"NativeFixedSizeMemoryPool<{typeof(T).Name}>";
        ...
        /// <returns>Equals</returns>
        public static bool operator ==(NativeFixedSizeMemoryPool<T> left, NativeFixedSizeMemoryPool<T> right) => left._handle == right._handle;
