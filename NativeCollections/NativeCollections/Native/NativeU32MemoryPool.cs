...
{
    /// <summary>
    ///     Native uint bitmap memory pool
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    [NativeCollection(FromType.None)]
    [BindingType(typeof(UnsafeU32MemoryPool))]
    public readonly unsafe struct NativeU32MemoryPool : IIsCreated, IDisposable, IEquatable<NativeU32MemoryPool>
    {
        /// <summary>
        ///     Handle
        /// </summary>
        private readonly UnsafeU32MemoryPool* _handle;
        ...
        {
            var value = new UnsafeU32MemoryPool(length, maxFreeSlabs, alignment);
        ...
        /// </summary>
        public bool Equals(NativeU32MemoryPool other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public override bool Equals(object? obj) => obj is NativeU32MemoryPool other && other.Equals(this);
        ...
        /// </summary>
        public override string ToString() => "NativeUInt32MemoryPool";

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(NativeU32MemoryPool left, NativeU32MemoryPool right) => left.Equals(right);
        ...
        ///     Empty
        /// </summary>
        public static NativeU32MemoryPool Empty => default;
    }
}