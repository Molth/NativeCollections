...
namespace NativeCollections
{
    ...
    internal unsafe struct TreiberStack<T> : IIsCreated, IDisposable, IEquatable<TreiberStack<T>> where T : unmanaged
    {
        ...
        /// </summary>
        public readonly bool Equals(TreiberStack<T> other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly override bool Equals(object? obj) => obj is TreiberStack<T> other && other.Equals(this);
        ...
        /// </summary>
        public readonly override string ToString() => SR.Format("TreiberStack<{0}>", SR.GetTypeName(typeof(T)));

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(TreiberStack<T> left, TreiberStack<T> right) => left.Equals(right);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TreiberStack<T> Create() => new();
    }
}