...
namespace NativeCollections
{
    ...
    internal unsafe struct EpochCollector : IIsCreated, IDisposable, IEquatable<EpochCollector>
    {
        ...
        /// </summary>
        public readonly bool Equals(EpochCollector other) => SpanHelpers.Equals(ref Unsafe.AsRef(in this), ref other);

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public readonly override bool Equals(object? obj) => obj is EpochCollector other && other.Equals(this);
        ...
        /// </summary>
        public readonly override string ToString() => "EpochCollector";

        /// <summary>
        ///     Indicates whether the current object is equal to another object.
        /// </summary>
        public static bool operator ==(EpochCollector left, EpochCollector right) => left.Equals(right);
        ...
        /// <returns>A disposable scope representing the pinned epoch.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public NativeEpochCollectorRefScope EnterRefScope() => new(NativeRef<EpochCollector>.Create(ref this), Pin());
        ...
        private void Collect()
        {
            ...
            if (slot.PinCount.load(Ordering.Acquire) == 0 && _globalEpoch.compare_exchange(globalEpoch, globalEpoch.wrapping_add(1)) == globalEpoch)
            {
                ...
                while (slot.Bag.TryDequeue(out var sealedBag))
                {
                    ...
                    {
                        garbage[count++] = sealedBag.Deferred;
        ...
        private readonly struct SealedBag
        {
            ...
            {
                _epoch = epoch;
                Deferred = new Deferred(data, call);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public bool IsExpired(uint epoch) => (int)epoch.wrapping_sub(_epoch) >= 1;
        }
        ...
        private struct Slot : IDisposable
        {
            ...
            public void Dispose()
            {
                while (Bag.TryDequeueMut(out var sealedBag))
                    sealedBag.Deferred.Call();
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EpochCollector Create() => new();
    }
}